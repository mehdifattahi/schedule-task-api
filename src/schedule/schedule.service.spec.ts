...
describe('ScheduleService', () => {
  ...
  it('should create a schedule', async () => {
    ...
    jest.spyOn(prismaService.schedule, 'create').mockResolvedValue(expectedResult);
  ...
  it('should return all schedules', async () => {
    const expectedResult = [
      { id: 'uuid1', accountId: 1, agentId: 1, startTime: new Date(), endTime: new Date() },
    ];

    jest.spyOn(prismaService.schedule, 'findMany').mockResolvedValue(expectedResult);
  ...
  it('should return a schedule by id', async () => {
    const id = 'uuid';
    const expectedResult = { id, accountId: 1, agentId: 1, startTime: new Date(), endTime: new Date() };

    jest.spyOn(prismaService.schedule, 'findUnique').mockResolvedValue(expectedResult);
  ...
  it('should update a schedule', async () => {
    ...
    jest.spyOn(prismaService.schedule, 'update').mockResolvedValue(expectedResult);
  ...
  it('should delete a schedule', async () => {
    ...
    jest.spyOn(prismaService.schedule, 'delete').mockResolvedValue(expectedResult);
